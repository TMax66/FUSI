...
# campiono dal dataset iniziale le matricole per simulare 5 differenti allevamenti con consistenza diverse per poi applicare quanto
visto sopra 
```{r}
...
dt %>% 
  sample_n(459) %>% 
  saveRDS(here("dati", "herdA"))
 
dt %>% 
sample_n(200)  %>% 
  saveRDS(here("dati", "herdB"))
 
dt %>% 
sample_n(50) %>% 
  saveRDS(here("dati", "herdC"))

dt %>% 
  sample_n(150) %>% 
  saveRDS(here("dati", "herdD"))

dt %>% 
  sample_n(625) %>% 
  saveRDS(here("dati", "herdE"))
